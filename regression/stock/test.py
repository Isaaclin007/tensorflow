            ...
            if day_trade_count < max_trade_count_1_day :
                ...
                if pred > predict_trade_threshold :
                    if (t0_open_increase < buying_threshold) or (t0_low_increase < buying_threshold) :
                        ...
                        capital_value += capital_ratio / 10.0 / float(max_trade_count_1_day) * ((out_price / buying_price) - 1.0)
...
print("max:")
TestEntry(max_capital_increase_threshold, max_capital_increase_max_trade_count_1_day, False)
