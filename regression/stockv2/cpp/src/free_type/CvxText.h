...
#ifndef VCA_OPENCV_CVX_TEXT_2007_08_31_H
#define VCA_OPENCV_CVX_TEXT_2007_08_31_H
...
public:
   ...
   void setFont(int font_size=20, const Scalar &color=Scalar(255,255,255), bool underline=0, float diaphaneity=1.0);
   void putTextMat(Mat &input_image, Point &o_pt, char *p_msg_buffer);
   void putTextMat(Mat &input_image, Point &o_pt, wchar_t *p_msg_buffer);
   int putTextMat(Mat &input_image, Rect &o_postion, char *p_msg_buffer);
