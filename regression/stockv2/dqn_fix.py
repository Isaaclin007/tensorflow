...
'
    ...
    # end_date = 20190221
    split_date = 20100101
    o_data_source = tushare_data.DataSource(20000101, '', '', 2, 20000101, end_date, False, False, True)
    # o_feature = feature.Feature(30, feature.FUT_D5_NORM, 1, False, False)
    o_feature = feature.Feature(20, feature.FUT_D5_NORM, 1, False, False)
    ...
    o_dqn_fix = DQNFix(o_data_source, o_feature, 20, False, DECAY_MODE_EXP, 0.9, not FLAGS.overlap_feature)
